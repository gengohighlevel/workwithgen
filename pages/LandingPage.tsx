...
const ProjectCard: React.FC<{ project: Project }> = ({ project }) => {
  ...
  return (
    <div 
      className="min-w-[340px] md:min-w-[440px] snap-center bg-white dark:bg-zinc-900/50 rounded-[2.5rem] overflow-hidden border border-gray-200 dark:border-zinc-800 hover:border-purple-300 dark:hover:border-purple-500/50 hover:shadow-[0_0_30px_rgba(168,85,247,0.15)] transition-all duration-500 group flex flex-col h-[680px]"
    >
      {/* Image Area */}
...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-black overflow-hidden transition-colors duration-300">
      {/* 1. Hero Section */}
      <section className="relative pt-24 pb-20 px-6 overflow-hidden bg-[#f5f5f7] dark:bg-black">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="z-10 text-center lg:text-left">
            <Reveal animation="animate-reveal-up" className="inline-block">
              <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full border border-purple-200 bg-purple-50/50 dark:bg-purple-900/20 dark:border-purple-800 mb-10 relative animate-border-pulse">
          ...
          <Reveal animation="animate-reveal-left" delay="animation-delay-200" className="relative mt-20 lg:mt-0 w-full flex items-center justify-center">
             <div className="relative w-full max-w-md mx-auto">
               ...
               {/* Floating Badges */}
               <div className="absolute -bottom-6 -left-4 md:-left-12 z-20 glass-card p-4 rounded-[1.5rem] w-44 md:w-56 scale-90 md:scale-100 shadow-lg transition-transform duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(168,85,247,0.15)] cursor-default">
               ...
               <div className="absolute top-[10%] -right-4 md:-right-12 z-20 glass-card p-3 md:p-4 rounded-[1.25rem] md:rounded-[1.5rem] w-48 md:w-68 scale-75 md:scale-100 border-white/40 shadow-xl transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(168,85,247,0.15)] cursor-default">
             ...
             <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150%] h-[150%] bg-gradient-to-br from-purple-200/20 to-indigo-200/20 dark:from-purple-900/10 dark:to-indigo-900/10 rounded-full blur-[140px] opacity-40 -z-0 pointer-events-none"></div>
          </Reveal>
        </div>
      </section>

      {/* 2. Scale with Real Data Section */}
      <section id="efficiency" className="py-24 bg-white dark:bg-black transition-colors">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 glass-card rounded-[2.5rem] p-6 md:p-10 relative overflow-hidden h-[320px] md:h-[400px] border-purple-100 dark:border-purple-900/30">
            ...
            <div className="flex flex-col gap-8">
              <div className="glass-card rounded-[2.5rem] p-8 flex-1 border-purple-100 dark:border-purple-900/30">
              ...
              <div className="glass-card rounded-[2.5rem] p-8 flex-1 border-indigo-100 dark:border-indigo-900/30">
      ...
      <section id="services" className="py-24 bg-[#fbfbfd] dark:bg-zinc-950 transition-colors">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
             {[
               ...
               <div key={i} className={`glass-card rounded-[2rem] p-8 transition-all duration-300 group border border-gray-100 dark:border-white/10`}>
      ...
      <section id="projects" className="py-24 bg-white dark:bg-black border-b border-gray-100 dark:border-zinc-800 transition-colors">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12">
            ...
            <div className="flex gap-2 mt-6 md:mt-0">
              <Magnetic strength={0.2}>
                <button 
                  onClick={() => scroll('left')}
                  className="w-10 h-10 rounded-full border border-gray-200 dark:border-zinc-700 flex items-center justify-center hover:bg-gray-100 dark:hover:bg-zinc-800 transition-colors focus:outline-none"
      ...
      <section id="features" className="py-32 bg-white dark:bg-black transition-colors">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <Reveal animation="animate-reveal-up" className="relative">
              ...
              />
              <div className="absolute -bottom-12 -right-4 glass-card p-6 rounded-[2rem] w-64 hidden md:block border-purple-100 dark:border-purple-900/30 z-10 shadow-2xl">
      ...
      <section className="py-24 bg-[#fbfbfd] dark:bg-zinc-950 transition-colors">
      ...
      {/* 6. Final CTA Banner */}
      <section id="contact" className="py-24 px-6 dark:bg-black transition-colors">
        <div className="max-w-6xl mx-auto bg-white dark:bg-zinc-900 border border-gray-100 dark:border-white/10 rounded-[4rem] p-12 md:p-24 text-center shadow-sm relative overflow-hidden">
