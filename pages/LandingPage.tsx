          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <Reveal animation="animate-reveal-left" delay="animation-delay-200" className="relative mt-20 lg:mt-0 w-full flex items-center justify-center">
               <div className="relative w-full max-w-md mx-auto">
                 ...
                 <a href="https://directory.gohighlevel.com/ghl/4ef3fc8725479f0e32bd41b0dd2313eb?from=badge" title="Find me on HighLevel Directory" target="_blank" rel="noopener noreferrer" className="absolute top-[30%] left-[8%] md:left-[5%] z-30 transition-transform duration-500 hover:-translate-y-2 hover:scale-105">
